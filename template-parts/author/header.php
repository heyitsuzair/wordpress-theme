    ...
    <div class="author-col-one mb-3 col-lg-3 col-md-3 col-sm-12">
        <div id="author-avatar" class="author-avatar d-flex align-items-start">
            ...
            if (!empty($has_avatar)) {
                ...
                printf(
                    '<span id="author-firstname" class="d-none">%1$s</span><span id="author-lastname" class="d-none">%2$s</span><div id="author-profile-img" style="width: 230px; height: 230px;" class="rounded-circle d-flex justify-content-center align-items-center bg-info position-relative"><span class="h1 text-white inset-center"></span></div>',
